...
"""
a=0 #global variable
user_details = {1234:['vimath','vim','sklm',8464836140]}
...
user_bookings ={2345:[1234,'vimath','odisha',10,'wed']}
# 1234:['vimath','odisha',10,'wed',6566959695]
...
while True:
    ...
    if option==1 :
        ...
        pnr_check = int(input("Enter your PNR number : "))
        if pnr_check in user_bookings:
            print("user id : ",user_bookings[pnr_check][0])
            print("user name : ",user_bookings[pnr_check][1])
            print("Train name : ",user_bookings[pnr_check][2])
        else:
            print("No PNR Available")
    elif option==4:
        print("*"*8,"Available seats","*"*8)
